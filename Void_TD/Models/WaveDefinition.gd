...
static func all_waves() -> Array:
	return [
		...
		# Wave 3 — first boss with light escort
		WaveData.new([
		...
		# Wave 6 — boss with full escort + heavy speeder push
		WaveData.new([
		...
		# Wave 11 — escalation begins, counts rise
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    15, 0.5),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     15, 0.95),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      3, 4.0),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,   6, 0.32),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  3, 2.0),
		], 0.5, _scale(10)),
		# Wave 12 — more tanks + shielded wall
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    16, 0.48),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     16, 0.9),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      3, 3.8),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,   8, 0.3),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  4, 1.9),
		], 0.5, _scale(11)),
		# Wave 13 — speeder swarm + boss pressure
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    18, 0.45),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     16, 0.88),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      4, 3.8),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  10, 0.28),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  4, 1.8),
		], 0.5, _scale(12)),
		# Wave 14 — heavy tank wall
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    18, 0.44),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     18, 0.85),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      4, 3.6),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,   8, 0.27),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  5, 1.8),
		], 0.5, _scale(13)),
		# Wave 15 — five bosses + everything
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    20, 0.42),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     18, 0.82),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      5, 3.6),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  10, 0.26),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  5, 1.7),
		], 0.5, _scale(14)),
		# Wave 16 — full density
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    20, 0.40),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     20, 0.80),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      5, 3.5),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  12, 0.25),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  6, 1.7),
		], 0.5, _scale(15)),
		# Wave 17 — shielded surge
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    22, 0.38),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     20, 0.78),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      6, 3.5),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  12, 0.24),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  6, 1.6),
		], 0.5, _scale(16)),
		# Wave 18 — boss storm
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    22, 0.37),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     22, 0.75),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      6, 3.4),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  14, 0.23),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  7, 1.6),
		], 0.5, _scale(17)),
		# Wave 19 — maximum before the finale
		WaveData.new([
			SpawnGroup.new(EnemyDefinition.EnemyType.SCOUT,    25, 0.35),
			SpawnGroup.new(EnemyDefinition.EnemyType.TANK,     22, 0.72),
			SpawnGroup.new(EnemyDefinition.EnemyType.BOSS,      7, 3.4),
			SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,  14, 0.22),
			SpawnGroup.new(EnemyDefinition.EnemyType.SHIELDED,  8, 1.5),
		], 0.5, _scale(18)),
	]
...
static func final_boss_wave() -> WaveData:
	return WaveData.new([
		...
		SpawnGroup.new(EnemyDefinition.EnemyType.SPEEDER,    6, 0.4),
	], 2.0, _scale(19))
