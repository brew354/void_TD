...
func _init() -> void:
	...
	_assert(TowerDefinition.max_count(TowerDefinition.TowerType.LASER) == 0, "Laser has no placement limit")
	_assert(TowerDefinition.max_count(TowerDefinition.TowerType.CANNON) == 6, "Cannon limit = 6")
	_assert(TowerDefinition.max_count(TowerDefinition.TowerType.MISSILE) == 4, "Missile limit = 4")
	_assert(TowerDefinition.max_count(TowerDefinition.TowerType.MECHA_SOLDIER) == 4, "Mecha limit = 4")
